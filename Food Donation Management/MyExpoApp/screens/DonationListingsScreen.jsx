...
const API_URL = "http://10.16.57.136:8000/api/donations/get-donations";
...
export default function DonationListingsScreen({ navigation }) {
  ...
  useEffect(() => {
    ...
    if (vegFilter !== null) {
      filtered = filtered.filter(
        (item) =>
          (vegFilter && item.foodType.toLowerCase().includes("veg")) ||
          (!vegFilter && item.foodType.toLowerCase().includes("non veg"))
      );
    }
    if (userLocation) {
  ...
  }, [donations, searchQuery, vegFilter, userLocation]);
  ...
  return (
    <View style={[styles.container, { backgroundColor: theme.colors.background }]}>
      ...
      <View style={[styles.searchSection, { backgroundColor: theme.colors.card }]}>
        ...
        <TouchableOpacity
          style={[styles.filterButton, vegFilter === null && styles.filterButtonActive]}
          onPress={() => setVegFilter(null)}
        >
          <Text style={[styles.filterButtonText, vegFilter === null && styles.filterButtonTextActive]}>All</Text>
        </TouchableOpacity>
        <TouchableOpacity
          style={[styles.filterButton, vegFilter === true && styles.filterButtonActive]}
          onPress={() => setVegFilter(true)}
        >
          <Text style={[styles.filterButtonText, vegFilter === true && styles.filterButtonTextActive]}>Veg</Text>
        </TouchableOpacity>
        <TouchableOpacity
          style={[styles.filterButton, vegFilter === false && styles.filterButtonActive]}
          onPress={() => setVegFilter(false)}
        >
          <Text style={[styles.filterButtonText, vegFilter === false && styles.filterButtonTextActive]}>Non Veg</Text>
        </TouchableOpacity>
      </View>
      </View>
